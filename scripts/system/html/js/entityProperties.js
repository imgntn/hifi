...
function clearUserDataForGroup(groupName, userDataElement) {
    var properties = {};
    var parsedData = {};
    try {
...
function userDataChanger(groupName, keyName, checkBoxElement, userDataElement, defaultValue, equippable) {
    var properties = {};
    var parsedData = {};
    try {
        parsedData = JSON.parse(userDataElement.value);
    ...
    if (equippable === true) {
        parsedData[groupName][keyName] = formatEquippableData();
    }
...
function formatEquippableData() {
    ...
    var data = {
        LeftHand: [{
            x: elements[0][0].value,
            y: elements[0][1].value,
            z: elements[0][2].value
        }, {
            x: elements[0][3].value,
            y: elements[0][4].value,
            z: elements[0][5].value,
            w: elements[0][6].value,
        }],
        RightHand: [{
            x: elements[1][0].value,
            y: elements[1][1].value,
            z: elements[1][2].value
        }, {
            x: elements[1][3].value,
            y: elements[1][4].value,
            z: elements[1][5].value,
...
function getEquippableElements() {
    var leftPositionX = document.getElementById("property-equip-left-position-x");
    var leftPositionY = document.getElementById("property-equip-left-position-y");
    var leftPositionZ = document.getElementById("property-equip-left-position-z");
    var leftRotationX = document.getElementById("property-equip-left-rotation-x");
    var leftRotationY = document.getElementById("property-equip-left-rotation-y");
    var leftRotationZ = document.getElementById("property-equip-left-rotation-z");
    var leftRotationW = document.getElementById("property-equip-left-rotation-w");

    var rightPositionX = document.getElementById("property-equip-right-position-x");
    var rightPositionY = document.getElementById("property-equip-right-position-y");
    var rightPositionZ = document.getElementById("property-equip-right-position-z");
    var rightRotationX = document.getElementById("property-equip-right-rotation-x");
    var rightRotationY = document.getElementById("property-equip-right-rotation-y");
    var rightRotationZ = document.getElementById("property-equip-right-rotation-z");
    var rightRotationW = document.getElementById("property-equip-right-rotation-w");

    var leftElements = [
        leftPositionX, leftPositionY, leftPositionZ,
        leftRotationX, leftRotationY, leftRotationZ, leftRotationW
    ]

    var rightElements = [
        rightPositionX, rightPositionY, rightPositionZ,
...
function setLocalPositionAndRotation() {
    ...
    if (currentlyEquippedHand === 'LeftHand') {
        localPosition = equipData.LeftHand[0],
            localRotation = equipData.LeftHand[1]
    }
    if (currentlyEquippedHand === 'RightHand') {
        localPosition = equipData.RightHand[0],
            localRotation = equipData.RightHand[1]
    }
...
var currentlyEquippedHand = 'none';
...
function loaded() {
    openEventBridge(function() {
        ...
        var elEquippable = document.getElementById("property-equippable");
        ...
        */
                        ...
                        try {
                            ...
                            if ("wearable" in parsedUserData) {
                                ...
                                if ("joints" in parsedUserData['wearable']) {
                                    ...
                                    if ("RightHand" in parsedUserData['wearable']['joints'] && parsedUserData['wearable']['joints']['RightHand'][0].x !== '') {
                                        hasRight = true;
                                    }
                                    if (hasLeft || hasRight) {
        ...
        var equipElements = getEquippableElements();

        elEquippable.addEventListener('change', function() {
            if (elEquippable.checked === false) {
                var equipGroup = document.getElementsByClassName('equippable')
                equipGroup[0].style.display = 'none';
                clearEquippableFields();
