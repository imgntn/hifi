...
var PopUpMenu = function(properties) {
    var value = properties.value,
        ...
        OPTION_MARGIN = 4,
        MIN_MAX_BUTTON_SVG = Script.resolvePath("assets/images/min-max-toggle.svg"),
...
var usersWindow = (function() {
    var baseURL = Script.resolvePath("assets/"),
        WINDOW_WIDTH = 160,
        WINDOW_MARGIN = 12,
        ...
        windowPane,
        windowHeading,
        MIN_MAX_BUTTON_SVG = baseURL + "images/tools/min-max-toggle.svg",
        MIN_MAX_BUTTON_SVG_WIDTH = 17.1,
        MIN_MAX_BUTTON_SVG_HEIGHT = 32.5,
        MIN_MAX_BUTTON_WIDTH = 14,
        MIN_MAX_BUTTON_HEIGHT = MIN_MAX_BUTTON_WIDTH,
        ...
        FRIENDS_BUTTON_SVG = baseURL + "images/tools/add-remove-friends.svg",
