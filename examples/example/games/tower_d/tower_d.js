...
var NUMBER_OF_TOWERS = 4;
var TOWERS_RADIUS_X = 20;
var TOWERS_RADIUS_Y = 20;
var NUMBER_OF_SPAWNERS = 12;
var SPAWNER_RADIUS_X = 60;
var SPAWNER_RADIUS_Y = 60;

var SPAWN_CREATURE_INTERVAL = 1000;
var MOVE_SEEKING_CREATURES_INTERVAL = 16;
var MOVE_CLIMBING_CREATURES_INTERVAL = 16;
...
createSpawner: function(position) {
    ...
    distributeSpawners: function(_numberOfPoints, radiusX, radiusY) {
    ...
    distributeTowers: function(_numberOfPoints, radiusX, radiusY) {
        var IS_VERTICAL = false;
        ...
        for (var pointNum = 0; pointNum < _numberOfPoints; pointNum++) {
            ...
            print('CREATE TOWER AT:' + pos.x + "/" + pos.y + "/" + pos.z);

            this.towers.push(this.createTower(pos));
        }
